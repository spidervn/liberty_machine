...
public:
    ...
    virtual int _IsSwitch_Machine(ISM* pCurrentMachine, int nMsg, int n_FromState, int n__To_State) = 0;                    // Checking if switch machines
    virtual int _InterTranslation(ISM* pCurrentMachine, ISM* pSwitchTo, int Msg1, int n_FromState1, int n_To_State1) = 0;   // Translate message into
};
